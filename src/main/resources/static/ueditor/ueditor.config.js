...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		// 服务器统一请求接口路径
		//,serverUrl : contextPath + "/framework/ueditor/jsp/controller.jsp"
	...
	// ,wordOverFlowMsg:'' //<span
	// style="color:red;">你输入的字符个数已经超出最大允许值，服务器可能会拒绝保存！</span>
	...
	// codeMirrorCssUrl css加载的路径，默认是 URL +
